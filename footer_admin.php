		...
		<div class="flex flex-col items-center space-y-6">
			...
			<div>
				<ul class="flex space-x-4 md:space-x-6">
					...
					<li>
						<?php echo "<a href='edit_profile_admin.php?id=$res_id' class='text-base md:text-lg font-medium hover:text-blue-200 transition-colors duration-300'>Edit Profile</a>" ?>
					</li>
				</ul>
			</div>
			<div class="text-center">
				<p class="text-sm">Contact us: <a href="tel:+60123456789">+60123456789</a></p>
			</div>
			<div class="text-center">
				<p><a href="mailto:info@utarhospital.my">info@ams.1utar.my</a></p>
