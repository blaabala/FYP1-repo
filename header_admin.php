            ...
            <div class="flex justify-between items-center">
                ...
                <div>
                    <ul class="flex space-x-6 items-center">
                        ...
                        <li><a href="lecturer_admin.php"
                                class="text-lg font-medium hover:text-blue-200 transition-colors duration-300">Lecturers</a>
                        </li>
                        <li>
                        <li><a href="student_admin.php"
                                class="text-lg font-medium hover:text-blue-200 transition-colors duration-300">Students</a>
                        </li>
