                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($row['status'] !== 'Cancelled'): ?>
                                                    <button type="button" class="btn btn-outline-warning" data-bs-toggle="modal" data-bs-target="#updateModal" data-id="<?php echo $row['id']; ?>">Update</button>
                                                <?php else: ?>
                            ...
                            <div class="modal-body">
                                <form action="appointment_insert.php" method="post">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input required type="text" class="form-control form-control-lg" id="title" name="title" placeholder="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="form-group col-md-6">
                                            <label for="requester_email">Your email</label>
                                            <input required type="email" class="form-control" id="requester_email" name="requester_email">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="accepter_email">Guest email</label>
                                            <input required type="email" class="form-control" id="accepter_email" name="accepter_email">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="form-group mb-4">
                                            <label for="from_time">From</label>
                                            <input required type="datetime-local" class="form-control" id="from_time" name="from_time">
                                        </div>
                                        <div class="form-group mb-4">
                                            <label for="to_time">To</label>
                                            <input required type="datetime-local" class="form-control" id="to_time" name="to_time">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label for=""></label>
                                        <textarea required class="form-control" id="description" name="description" rows="3" placeholder="Description"></textarea>
                                    </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form action="appointment_update.php" method="post">
                                <div class="modal-body">
                                    <div class="form-group row">
                                        <label for="update_status" class="col-sm-2 col-form-label col-form-label-lg">Status</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="form-group row">
                                        <label for="update_title" class="col-sm-2 col-form-label col-form-label-lg">Title</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control form-control-lg" id="update_title" name="title" placeholder="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="form-group col-md-6">
                                            <label for="update_requester_email">Requester email</label>
                                            <input type="email" class="form-control" id="update_requester_email" name="requester_email" value="">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="update_accepter_email">Accepter email</label>
                                            <input type="email" class="form-control" id="update_accepter_email" name="accepter_email" value="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="form-group mb-4">
                                            <label for="update_from_time">From</label>
                                            <input type="datetime-local" class="form-control" id="update_from_time" name="from_time">
                                        </div>
                                        <div class="form-group mb-4">
                                            <label for="update_to_time">To</label>
                                            <input type="datetime-local" class="form-control" id="update_to_time" name="to_time">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="update_description" name="description" rows="3" placeholder="Description"></textarea>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                                    <button class="btn btn-primary" type="button" onclick="showConfirmationModal()">Update</button>
                                </div>
                            </form>
                        </div>
                    </div>
