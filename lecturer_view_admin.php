...
if (isset($_GET['delete_id'])) {
    ...
    if ($stmt->execute()) {
        ...
        $_SESSION['error_message'] = "Error deleting lecturer.";
    }
    $stmt->close();
...
<body class="main-box top">
    ...
    <main>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h2 style="text-align: center;">Lecturer List</h2>
                        ...
                        <div class="card-body">
                            <table class="product-table" id="lecturerTable">
                                <thead>
                                    <tr>
                                        <th>No.</th>
                                        <th>Lecturer Name</th>
                                ...
                                <tbody>
                                    ...
                                    if ($lecturers_result->num_rows === 0) {
                                        echo "<tr><td colspan='7' style='text-align: center;'>No lecturers found.</td></tr>";
                                    } else {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo htmlspecialchars($lecturer["faculty"] ?? 'N/A'); ?></td>
                                        <td><?php echo htmlspecialchars($lecturer["department"] ?? 'N/A'); ?></td>
                                        <td><?php echo htmlspecialchars($lecturer["designation"] ?? 'N/A'); ?></td>
                                        <td><?php echo htmlspecialchars($lecturer["office_no"] ?? 'N/A'); ?></td>
                                        <td>
                                            <button type="button" class="btn btn-outline-warning" data-bs-toggle="modal"
                                                data-bs-target="#updateModal"
                                                data-id="<?php echo $lecturer['id']; ?>">Update</button>
                                            <a href="lecturer_view_admin.php?delete_id=<?php echo $lecturer['id']; ?>"
                ...
                <!-- Create New Lecturer Modal -->
                <div class="modal fade" id="createModal" tabindex="-1" aria-labelledby="createModalLabel"
                    aria-hidden="true" data-bs-backdrop='static'>
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="createModalLabel">Create New Lecturer</h1>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <form action="lecturer_insert_admin.php" method="post">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input required type="text" class="form-control form-control-lg"
                                                id="username" name="username" placeholder="Enter lecturer's full name">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input required type="text" class="form-control" id="department"
                                    ...
                                    <div class="form-group row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input required type="text" class="form-control" id="designation"
                                                name="designation" placeholder="Enter designation">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="office_no">Office No.</label>
                                            <input required type="text" class="form-control" id="office_no"
                                                name="office_no" placeholder="Enter office number">
                                        </div>
                                    </div>
                ...
                <div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="updateModalLabel"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="updateModalLabel">Update Lecturer</h1>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                            </div>
                            <form action="lecturer_update_admin.php" method="post">
                                <div class="modal-body">
                                    <input type="hidden" name="lecturer_id" id="update_lecturer_id" value="">
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input required type="text" class="form-control" id="update_department"
                                                name="department">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input required type="text" class="form-control" id="update_designation"
                                                name="designation">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="update_office_no">Office No.</label>
                                            <input required type="text" class="form-control" id="update_office_no"
                                                name="office_no">
                                        </div>
                                    </div>
                                </div>
    ...
    updateModal.addEventListener('show.bs.modal', function(event) {
        ...
        form.querySelector('#update_lecturer_id').value = lecturerId;

        fetch(`lecturer_fetch_admin.php?id=${lecturerId}`)
            .then(response => {
                if (!response.ok) {
            ...
            .then(data => {
                ...
                form.querySelector('#update_department').value = data.department || '';
                form.querySelector('#update_designation').value = data.designation || '';
                form.querySelector('#update_office_no').value = data.office_no || '';
            })
    ...
    document.getElementById('searchButton').addEventListener('click', function() {
        ...
        fetch(`lecturer_search_admin.php?term=${encodeURIComponent(searchTerm)}`)
            .then(response => response.text())
            .then(html => {
                document.getElementById('lecturerTable').innerHTML = html;
            })
            .catch(error => console.error('Error searching lecturers:', error));
    });
